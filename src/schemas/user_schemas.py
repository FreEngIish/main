...
class CreateUserRequest(BaseModel):
    username: str = Field(..., min_length=6, max_length=150, description="Username must be between 6 and 150 characters long")
...
class UpdateUserRequest(BaseModel):
    username: Optional[str] = Field(None, min_length=6, max_length=150, description="Username must be between 6 and 150 characters long")
